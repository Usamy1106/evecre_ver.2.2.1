...
const TEMPLATES = [
  ...
  // ── party（物販・飲食の出店がある「フェス・マーケット」向け）────────
  // 作成フローの eventType='festival_market' は party に写る（proposalEngine の
  // EVENT_TYPE_TO_CATEGORY）。既存の party 12件は宴会寄り（席次表・ドレスコード・
  // 司会台本）で出店運営のタスクが無かったため補った。
  { id: 'pa-o4', title: '出店・販売に必要な許可を確認する',
    description: '会場や自治体に必要な届出・許可を洗い出します。飲食を伴う場合は保健所への確認が必須です。',
    tag: '運営', format: 'text', categories: ['party'] },
  { id: 'pa-o5', title: '会計・釣り銭・キャッシュレスの準備をする',
    description: '当日の支払い方法を決め、釣り銭とレジ担当を用意します。売上の記録方法まで決めておきましょう。',
    tag: '運営', format: 'text', categories: ['party'] },
  { id: 'pa-o6', title: '食品衛生と食材管理のルールを決める',
    description: '食材の保管温度・手洗い・使い捨て手袋など当日の衛生ルールを決めます。担当者に事前共有しましょう。',
    tag: '運営', format: 'text', categories: ['party'] },
  { id: 'pa-o7', title: '出店者を募集して条件をすり合わせる',
    description: '出店してくれる人・団体を集め、出店料・区画・搬入時間などの条件を書面で揃えます。',
    tag: '運営', format: 'text', categories: ['party'] },
...
const TEMPLATE_PHASES = {
  ...
  'pa-o4':  ['early', 'mid'],    // 出店許可（早めに動かないと間に合わない）
  'pa-o5':  ['mid', 'late'],     // 会計・釣り銭
  'pa-o6':  ['mid', 'late'],     // 食品衛生
  'pa-o7':  ['early', 'mid'],    // 出店者募集
  // general
  'ge-p1':  ['early'],           // 会場決め
  'ge-p2':  ['early'],           // KPI
  'ge-p3':  ['early'],           // マイルストーン
