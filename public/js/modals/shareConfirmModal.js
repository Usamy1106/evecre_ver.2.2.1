// ===== 「他の団体にも役立ちそう」の初回確認（イベントごとに1回）=====
//
// 振り返りの「他の団体にも役立ちそう」に、このイベントで**初めて**チェックが入ったときだけ確認する。
...
//   開催後にイベント設定で「タスクも含めて公開」をオンにしたときだけ（lib/publicData.js）。
//
    ...
    overlay.innerHTML = `
      <div class="c-modal u-animate-fade" role="dialog" aria-modal="true" aria-labelledby="share-confirm-title">
        ...
        <p class="c-modal__text">
          ...
          実際に公開されるのは、開催後に管理者が「タスクも含めて公開」をオンにしたときだけです。
        </p>
