...
export const MISSION_DESCRIPTIONS = {
  ...
  'def-3': "どのようなイベントにするかを整理しましょう。目的を具体化し、関係者全員の認識をそろえる土台になります。「いつ、どこで、誰に、何を、どう届けるか（5W1H）」を書き出し、理想を現実に落とし込みましょう。",
...
// ★def-1 は目的リマインドの引用元。def-3（企画の整理）はアーカイブの概要とは切り離した（2026-09-26）。
