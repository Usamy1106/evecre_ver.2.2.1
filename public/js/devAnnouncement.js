...
export const DEV_ANNOUNCEMENT = {
  version: '2026-07-12-01',   // 例: '2026-07-12-01'（日付＋連番など、前回と異なる文字列であれば形式自由）
  title: 'ミッションチャット機能を実装しました',     // 例: 'ミッションチャット機能を実装しました'
  body: 'ミッション詳細ページでメンバー同士がやり取りできるようになりました。',      // 例: 'ミッション詳細ページでメンバー同士がやり取りできるようになりました。\n返信やリアクションにも対応しています。'
